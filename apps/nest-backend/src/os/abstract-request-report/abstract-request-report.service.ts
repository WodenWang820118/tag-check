...
import { ABSTRACT_REQUEST_REPORT_FILE_NAME } from '../../configs/project.config';
import { FileService } from '../file/file.service';

// TODO: interface for both abstract report services and abstract request report services

@Injectable()
export class AbstractRequestReportService {
  constructor(
    ...
    try {
      ...
      const abstractPath =
        await this.filePathService.getInspectionResultFilePath(
          projectName,
          eventName,
          ABSTRACT_REQUEST_REPORT_FILE_NAME
        );
